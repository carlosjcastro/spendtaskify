...
export default function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!sanitizedPassword) {
      ...
      if (
        ...
        newErrors.password =
          "Password must include at least 1 uppercase letter, 1 number, 1 special character and be at least 8 characters.";
      }
    }

    // Se valida la confirmación de la contraseña
  ...
  const { strength, requirements } = password
    ? passwordStrength(password)
    : { strength: 0, requirements: {} };
      ...
      >
        ...
        <div className="mb-6">
          ...
          <ul className="mt-3 text-sm text-[#74C69D]">
            <li
              className={
                requirements.hasUpperCase ? "text-[#74C69D]" : "text-[#ef233c]"
              }
            >
              {requirements.hasUpperCase
            ...
            <li
              className={
                requirements.hasNumber ? "text-[#74C69D]" : "text-[#ef233c]"
              }
            >
              {requirements.hasNumber
            ...
            <li
              className={
                requirements.length ? "text-[#74C69D]" : "text-[#ef233c]"
              }
            >
              {requirements.length
            ...
            <li
              className={
                requirements.longLength ? "text-[#74C69D]" : "text-[#ef233c]"
              }
            >
              {requirements.longLength
        ...
        <div className="mb-6">
          ...
          <div
            className={`${inputWrapperStyles} ${
              errors.confirmPassword ? "border-[#ef233c]" : "border-[#95D5B2]"
            } focus-within:ring-[#52B788]`}
          >
            <FaLock className="text-[#95D5B2] mr-3" />
            <input
